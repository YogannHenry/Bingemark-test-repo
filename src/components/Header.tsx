...
import { Search, Settings, BookmarkPlus, FolderPlus, Download, ChevronDown } from 'lucide-react';
    ...
    <header className="flex items-center justify-between mb-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          {isDisplayMenuOpen && (
            <DisplaySettingsMenu onClose={() => setIsDisplayMenuOpen(false)} />
          )}
        </div>
        ...
        <div className="relative">
          ...
          {isCategoryVisibilityMenuOpen && (
            <CategoryVisibilityMenu onClose={() => setIsCategoryVisibilityMenuOpen(false)} />
          )}
        </div>
        ...
        <div className="relative">
          <button
            ...
            className="bg-sky-600 hover:bg-sky-700 rounded-full p-2 flex items-center gap-1"
            title="Import/Export"
          >
          ...
          {isImportMenuOpen && (
            <ImportExportMenu onClose={() => setIsImportMenuOpen(false)} />
          )}
        </div>
      </div>
    </header>
